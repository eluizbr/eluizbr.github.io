      ...
      $('.log-tabs a').click(function() {
        $(this)
          ...
          'all' == $(this).attr('data-type')
            ...
            : $('.logs-list li')
                .hide()
                .filter('[data-type="' + $(this).attr('data-type') + '"]')
                .show();
      }),
            ...
            $('#session-dialog').modal('hide'),
              ...
              $(document).on('active.idleTimer', function(e, o, i, s) {
                clearTimeout(t),
                  ...
                  toastr.clear(),
                  toastr.success(
                    'You returned to the active mode.',
                    'You are back.'
                  );
              });
          })(+$('#timeout-count').val());
