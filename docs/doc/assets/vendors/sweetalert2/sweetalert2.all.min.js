!(function(e, t) {
  ...
  var t = 'SweetAlert2:',
    ...
    X = function(e) {
      ...
      if (
        ...
        var f = function(e) {
          De.isVisible() && o !== e.target.value && De.resetValidationMessage(),
            (o = e.target.value);
        };
        return (
          (a.oninput = f),
  ...
  function Oe() {
    ...
    e.showConfirmButton ||
      (K(t.confirmButton), e.showCancelButton || K(t.actions)),
    ...
    qe = Object.freeze({
      ...
      _main: function(e) {
        ...
        !(function(t) {
          ...
          t.showCloseButton
            ? (c.setAttribute('aria-label', t.closeButtonAriaLabel), U(c))
            : K(c),
            (e.className = D.popup),
            t.toast
        ...
        return new Promise(function(t, n) {
          var o = function(e) {
              j.closePopup(T.onClose, T.onAfterClose),
                ...
                switch (e.type) {
                  case 'click':
                    if (i && j.isVisible())
                          ...
                          T.expectRejections
                            ...
                            : s.then(
                                function(e) {
                                  L.enableButtons(),
                                    L.enableInput(),
                                    e ? L.showValidationMessage(e) : l(a);
                                },
                                function(e) {
                                  return u(e);
                                }
                      ...
                      r &&
                        j.isVisible() &&
                        (L.disableButtons(), c(j.DismissReason.cancel));
                }
              },
          ...
          if (
            ...
            (M.popup.onmousedown = function() {
              ...
              (M.container.onclick = function(e) {
                a
                  ? (a = !1)
                  : e.target === M.container &&
                    I(T.allowOutsideClick) &&
                    c(j.DismissReason.backdrop);
              });
          }
          T.reverseButtons
          ...
          for (
            ...
            if ((d = L.getInput(f[m]))) {
              ...
              for (var y in T.inputAttributes)
                d.setAttribute(y, T.inputAttributes[y]);
            }
          ...
          switch (T.input) {
            ...
            case 'url':
              ...
              break;
            case 'file':
              ((d = W(M.content, D.file)).placeholder = T.inputPlaceholder),
                (d.type = T.input),
                U(d);
              break;
            case 'range':
            ...
            case 'textarea':
              ...
              (O.value = T.inputValue),
                (O.placeholder = T.inputPlaceholder),
                U(O);
              break;
            case null:
              break;
  ...
  'undefined' != typeof window &&
    window.Sweetalert2 &&
    ((window.Sweetalert2.version = '7.28.10'),
