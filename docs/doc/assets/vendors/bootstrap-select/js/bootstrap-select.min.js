...
!(function(e, t) {
  ...
  !(function(F) {
    ...
    function u(e) {
      ...
      if (([].shift.apply(l), !_.success)) {
        try {
          ...
          _.full = p.BootstrapVersion.split(' ')[0].split('.');
        }
        (_.major = _.full[0]),
          (_.success = !0),
          '4' === _.major &&
        ...
        if (e.is('select')) {
          ...
          if (t) {
            ...
            (n.template = F.extend(
              ...
              e.data('selectpicker', (t = new p(this, n)));
          }
          'string' == typeof r &&
    ...
    (p.VERSION = '1.13.3'),
      ...
      '4' === _.major &&
        ((p.DEFAULTS.style = 'btn-light'),
        (p.DEFAULTS.iconBase = ''),
        (p.DEFAULTS.tickIcon = 'bs-ok-default')),
      (p.prototype = {
        constructor: p,
        init: function() {
          var i = this,
        ...
        createView: function(C, e) {
          ...
          function i(e, t) {
            ...
            if (
              ...
              v = 0;
              for (var S = $.length; v < S; v++) I.appendChild($[v]);
              !0 === m &&
                ((b =
              ...
              if (
                ...
                if (f && !0 !== n.divider) {
                  ...
                  if (!this.previousElementSibling) {
                    ...
                    D.push(M(E, 'dropdown-header' + x, N)),
                      L.push({
                        content: k,
                        subtext: $,
                        type: 'optgroup-label',
        ...
        setMenuSize: function(e) {
          ...
          'auto' === this.options.dropdownAlignRight &&
            this.$menu.toggleClass(
              ...
              this.sizeInfo.selectOffsetLeft >
                this.sizeInfo.selectOffsetRight &&
                this.sizeInfo.selectOffsetRight < this.$menu[0].offsetWidth - a
            ),
            this.$menu.css({
              'max-height': o + 'px',
              overflow: 'hidden',
        ...
        clickListener: function() {
          ...
          t.data('spaceSelect', !1),
            ...
            this.$element.on({
              change: function() {
                S.render(),
                  S.$element.trigger('changed.bs.select', y),
                  (y = null);
              },
              focus: function() {
        ...
        keydown: function(e) {
          var t,
            ...
            a = (r ? l.closest('.dropdown') : l.closest(L.MENU)).data('this'),
            c = a.findLis(),
            d = !1,
    ...
    var v = F.fn.selectpicker;
    (F.fn.selectpicker = u),
      (F.fn.selectpicker.Constructor = p),
      (F.fn.selectpicker.noConflict = function() {
        return (F.fn.selectpicker = v), this;
      }),
      F(document)
